...
class MindCuber(object):
    ...
    def rotate_cube(self, direction, nb):
        ...
        print("rotate_cube() direction %s, nb %s, current_pos %d, final_pos %d" % (direction, nb, current_pos, final_pos))
    ...
    def flipper_hold_cube(self, speed=300):
        ...
        if (current_position <= MindCuber.hold_cube_pos - 10 or
            ...
            sleep(0.15) # change to 0.15s later
    ...
    def flip(self):
        ...
        self.flipper.on_to_position(SpeedDPS(self.flip_speed), 200)
        sleep(0.1) #0.05
    ...
    def move(self, face_down):
        ...
        actions = {
            0: ["flip", "delay", "flip"],
            1: [],
            2: ["rotate_cube_2", "delay", "flip"],
            3: ["rotate_cube_1", "delay", "flip"],
            4: ["flip", "delay"],
            5: ["rotate_cube_3","delay", "flip"]
        }.get(position, None)
