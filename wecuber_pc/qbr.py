...
class Qbr:
        ...
        def run(self):
            ...
            self.cvscan = Webcam()
            state = self.cvscan.run()
            # print("Results received in {}" .format(state))
...
if __name__ == "__main__":
    cubestring = tracker()
    # algorithm  = solve(20,2,cubestring,1,goalstring= None)
    # length = len(algorithm.split(' '))